...
This illustrate a few elements of sampling design presented in the **NFI eLearning Module 3: Sampling**: the difference between these sampling methods doesn't translate to major differences in plot allocation per land cover classes, but rather to statistical considerations.

::::::{.question data-latex=""}

In particular, what makes Simple random sampling not suitable for National Forest Inventories:

1. You have no control over plot distribution.
1. **There is a higher chance of plot autocorrelation.**
...
And what makes uneven systematic sampling better that systematic sampling for National Forest Inventories:
