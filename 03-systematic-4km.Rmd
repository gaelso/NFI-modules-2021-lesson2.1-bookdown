...
# Systematic sampling: 4 km grid {sys4}
...
Good job! The 4 km grid looks like exactly what we need. Let's still design a 3 km grid to see how many forest plots it would generate and practice the R code.
