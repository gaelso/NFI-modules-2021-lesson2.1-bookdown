...
1. Based on our available budget we have identified a suitable range of **sampling sizes**.
1. We have then created different **sampling grids** to ```r newland_name``` and estimated how many plots would fall on forest land.
1. We have selected the most adequate sampling grid based on our **budget/precision trade-off**.
