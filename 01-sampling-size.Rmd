...
n05 <- ((fi_agb$sd_agb / fi_agb$mean_agb * 100) * 1.96 / 5)^2
n05
...
## Console
n10 <- ((fi_agb$sd_agb / fi_agb$mean_agb) * ___ / ___)^2
n10
...
n10 <- ((fi_agb$sd_agb / fi_agb$mean_agb * 100) * 1.96 / 10)^2
n10
...
n15 <- ((fi_agb$sd_agb / fi_agb$mean_agb * 100) * 1.96 / 15)^2
n15
...
n20 <- ((fi_agb$sd_agb / fi_agb$mean_agb * 100) * 1.96 / 20)^2
n20
