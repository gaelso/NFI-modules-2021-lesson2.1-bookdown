...
1. Make the sampling size equal to the original number of points in a 4 x 4 km grid `nrow(sf_points4)` and accept that the result may be different from the systematic sampling. 
